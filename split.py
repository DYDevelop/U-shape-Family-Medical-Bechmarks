...
# python main.py --model U_Net --base_dir ../data/axi --train_file_dir axi_train.txt --val_file_dir axi_val.txt --base_lr 0.01 --epoch 300 --batch_size 8 --patience 10 --num_classes 2
